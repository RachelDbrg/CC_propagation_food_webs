...
make_ODE <- function(PP, data){
  ...
  #print(length(yini))  # Should print 12
  #print(yini)          # Check the contents of yini
  ...
  # new_column_names <- c("rfonc_P_Mj", "Pa", "Pj",
  #                       "Ma", "Mj", "U", "Ca", "Cj",
  #                       "Na", "Nj", "Qa", "Qj")
  ...
  # columns_to_rename <- paste0("V", 15:length(res))
  # columns_to_rename <- c("V14", "V53", "V84", "V54", "V55", "V56", "V63", "V64",
  # "V69", "V70", "V93", "V94")
  
  columns_to_rename <- paste0("V", 14:length(res))
